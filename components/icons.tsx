...
export const PrintIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6 3.189m0 10.64L6 3.189m0 10.641a42.415 42.415 0 0 0 10.56 0m-10.56 0L18 3.189m0 10.64L18 3.189m0 10.641a42.415 42.415 0 0 0-10.56 0M12 6.375h.008v.008H12V6.375Zm-3.75 0h.008v.008H8.25V6.375Zm7.5 0h.008v.008h-.008V6.375Z" />
